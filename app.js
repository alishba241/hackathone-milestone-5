...
function downloadHTMLpdf() {
    ...
    if (resumeElement) {
        ...
        const data = "data:text/html;charset=utf-8," + encodeURIComponent(resumeContent);
...
(_c = document.getElementById("shareBtn")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => {
